...
MAX_USER_PAGES = 1                # 每个用户主页最多翻页数（0=不限；内部有安全上限防止异常死循环）
MAX_POSTS_PER_USER = 5            # 每个用户主页最多抓多少条帖子
MAX_FOLLOWERS_PAGES = 1           # 每个用户粉丝列表最多翻页数（0=不限；内部有安全上限）
MAX_FOLLOWINGS_PAGES = 1          # 每个用户关注列表最多翻页数（0=不限；内部有安全上限）
